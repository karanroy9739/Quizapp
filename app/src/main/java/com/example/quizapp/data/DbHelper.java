...
import static com.example.quizapp.data.QuizContract.MovieEntry.KEY_OPTD;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    {
        Question q1=new Question("1.  Evaluate the following Java expression, if x=3, y=5, and z=10:\\n\" + \"\\n\" + \"++z + y - y + z + x++", "a)24", "b)23", "c)20", "d)25", "d)25");
        this.addQuestion(q1);
        ...
        this.addQuestion(q2);
        Question q3=new Question("3. What does the expression float a = 35 / 0 return?","a)0","b)not a number","c)infinity","d)run time exception","c)infinity" );
        this.addQuestion(q3);
        ...
        this.addQuestion(q5);
        Question q7=new Question("7. Which of the following is a valid long literal?","a)ABH8097","b)L990023","c)904423","d)0xnf029L","d)0xnf029L");
        this.addQuestion(q7);
